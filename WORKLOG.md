...
### E3 docs 문제 빌더 모듈 분리
- 수행 일시: 2026-03-04
- 결과: `docs/problems.js`의 대형 단일 파일을 `docs/problemBuilders/p000~p004.js`로 분리
- 효과: 문제별 유지보수성 향상, 충돌 범위 축소

### E4 docs 앱 안정성 보강
- 수행 일시: 2026-03-04
- 결과: 문제 미등록 상태/잘못된 step 반환에 대한 방어 로직 추가
- 효과: 실행 실패 메시지 명확화 및 런타임 오류 감소
